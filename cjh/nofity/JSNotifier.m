...
- (void)drawRect:(CGRect)rect{
    ...
    CGContextSetFillColorWithColor(context, SYS_MAIN_COLOR_NORMAL.CGColor);
    ...
    CGRect imageBounds = CGRectMake(0.0f, 0.0f, [UIScreen mainScreen].bounds.size.width, 0.0f);
	CGRect bounds = CGRectMake(0, 0, SCREEN_WIDTH, 0);
	CGFloat alignStroke;
	CGFloat resolution;
