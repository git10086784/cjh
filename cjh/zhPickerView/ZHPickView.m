...
-(void)setUpPickView{
    ...
    pickView.frame=CGRectMake(0, SCREEN_HEIGHT+20-pickView.frame.size.height, pickView.frame.size.width, pickView.frame.size.height);
    _pickeviewHeight=pickView.frame.size.height;
    [self addSubview:pickView];
    
    if (!self.backImageView) {
        self.backImageView = [[UIView alloc] initWithFrame:CGRectMake(0,0,SCREEN_WIDTH,SCREEN_HEIGHT+20-ZHToobarHeight-_pickeviewHeight)];
...
-(void)setUpDatePickerWithdatePickerMode:(UIDatePickerMode)datePickerMode{
    ...
    datePicker.frame=CGRectMake(0, SCREEN_HEIGHT+20-datePicker.frame.size.height, datePicker.frame.size.width, datePicker.frame.size.height);
...
-(UIToolbar *)setToolbarStyle{
    ...
    toolbar.backgroundColor = SYS_MAIN_COLOR_NORMAL;
    ...
    lefttem.tintColor = [UIColor whiteColor];
...
-(void)setToolbarWithPickViewFrame{
    _toolbar.frame=CGRectMake(0, SCREEN_HEIGHT+20-_pickeviewHeight-ZHToobarHeight,[UIScreen mainScreen].bounds.size.width, ZHToobarHeight);
}
