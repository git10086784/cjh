...
#define kButtonBottomOffset 10.0f
        ...
        [self.rightBtn setBackgroundImage:[UIImage imageWithColor:SYS_MAIN_COLOR_NORMAL] forState:UIControlStateNormal];
        [self.leftBtn setBackgroundImage:[UIImage imageWithColor:SYS_MAIN_COLOR_NORMAL] forState:UIControlStateNormal];
